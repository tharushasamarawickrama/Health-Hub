        ...
        <form class="DrProfiledetails-profile-details-form" method="POST"  enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input class="DrProfiledetails-input" type="text" id="employeeNo" name="employeeNo" value="<?php echo $data['slmcNo']?>" readonly>
                </div>
                <div class="form-group">
            ...
            <a href="<?php echo URLROOT; ?>/PhProfiledetails?id=<?php echo $data['user_id'] ?>" class="back-btn"><button type="button" class="save-btn" id="dr-req-btn-left">BACK</button></a>

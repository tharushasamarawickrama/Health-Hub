    ...
    <div class="slmc-image-view-body">
        <div class="slmc-image-view-container">
            ...
            <div class="slmc-image-display">
                <img src="<?php echo URLROOT; ?>/<?php echo $data['slmc_photo']?>" alt="Image" class="slmc-display-image">
            </div>
            ...
            <div class="slmc-image-actions">
                <a href="<?php echo URLROOT;?>/DrReqProfile?id=<?php echo $data['req_id'] ?>" class="slmc-back-btn" id="dr-req-btn-left">Back</a>
            </div>
        </div>
    </div>
</div>

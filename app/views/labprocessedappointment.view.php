...
<div class="lab-proc-app-container">
    <div class="lab-proc-app-content">
        <div class="lab-proc-app-button-container">
            <a href="<?php echo URLROOT; ?>/labprocessedprescriptions" class="lab-proc-app-button">
                Back
            </a>
        </div>
        <div class = "lab-proc-app-action-buttons">
            <form action="<?php echo URLROOT; ?>/labprocessedappointment/markAsPending" method="POST">
                ...
                <button type="submit" class="lab-proc-app-button">Mark as Pending</button>
            </form>
        </div>
    </div>
        <div class="lab-proc-app-prescription-details">
            ...
            <div class="lab-proc-app-uploaded-reports">
                ...
                <?php foreach ($pdfNames as $index => $pdfName): ?>
                    ...
                    <a href="<?php echo URLROOT; ?>/<?php echo htmlspecialchars($pdfPaths[$index]); ?>" target="_blank">
                    View</a>               
                 </div>
                    <button class = "lab-proc-app-button" onclick="confirmDelete('<?php echo $labtest_id[$index]; ?>', '<?php echo $data['appointment_id']; ?>')">Delete</button>                    
                    <?php endforeach; ?>
                <?php else: ?>

...
//   // Track and display ongoing appointment
// document.querySelectorAll(".view-appointment-card").forEach((card) => {
//   card.addEventListener("click", (e) => {
//     const id = card.querySelector(".appointment-id")?.textContent;
//     const name = card.querySelector(".appointment-name")?.textContent;
//     const ongoingBanner = document.getElementById("ongoing-appointment");

//     document.getElementById("ongoing-id").textContent = id;
//     document.getElementById("ongoing-name").textContent = " - " + name;
